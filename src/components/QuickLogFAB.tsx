  ...
  return (
    <>
          ...
          <div className="mt-6 space-y-2">
            {medications.length === 0 ? (
              <p className="text-sm text-muted-foreground text-center py-8">
                No medications added yet. Go to Manage to add some.
              </p>
            ) : (
              medications.map((med) => (
                <Button
        ...
        <SheetContent side="bottom" className="h-[80vh]">
          ...
          <div className="mt-6 space-y-2">
            {measurements.length === 0 ? (
              <p className="text-sm text-muted-foreground text-center py-8">
                No health tracking items added yet. Go to Manage to add some.
              </p>
            ) : (
      ...
      <LogMedicationDialog
        ...
        medication={selectedMedication || { id: "", name: "", dosage: null }}
      ...
      <LogMeasurementDialog
        ...
        measurement={selectedMeasurement || { id: "", name: "", unit: null }}
        onLogAdded={handleLogComplete}
      />
    </>
  );
